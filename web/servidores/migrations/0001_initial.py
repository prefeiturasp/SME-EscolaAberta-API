# Generated by Django 2.1.5 on 2019-03-14 16:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tp_unidade_educacao_atual', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('cd_unidade_base', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='unidade_base', to='escolas.Escolas')),
                ('cd_unidade_educacao_atual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='unidade_atual', to='escolas.Escolas')),
                ('cd_unidade_funcao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='escolas.Escolas')),
                ('cd_unidade_sobreposto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='unidade_sobreposto', to='escolas.Escolas')),
            ],
        ),
    ]
