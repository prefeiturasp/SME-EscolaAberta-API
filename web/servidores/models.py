...
class Servidores(models.Model):
    ...
    cd_unidade_base = models.ForeignKey(Escolas, related_name='unidade_base', blank=True, null=True,
    ...
    cd_unidade_educacao_atual = models.ForeignKey(Escolas, related_name='unidade_atual', blank=True, null=True,
                                                  on_delete=models.DO_NOTHING)
    tp_unidade_educacao_atual = models.CharField(max_length=100, blank=True, null=True)
    ...
    cd_unidade_funcao = models.ForeignKey(Escolas, blank=True, null=True, on_delete=models.DO_NOTHING)
    ...
    cd_unidade_sobreposto = models.ForeignKey(Escolas, related_name='unidade_sobreposto', blank=True, null=True,
                                              on_delete=models.DO_NOTHING)
